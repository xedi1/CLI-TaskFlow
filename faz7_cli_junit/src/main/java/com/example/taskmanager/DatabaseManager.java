...
public class DatabaseManager {
     ...
     * @return yekta instance az DatabaseManager
     */
     ...
     * @param dataStore dataStore jadid
     */
    ...
    /**
     * login karbar - check name va ramz obur
    ...
    public void login(String nameKarbari, String ramzObur) throws UserNotFoundException {
        if (!dataStore.karbarExist(nameKarbari)) {
            throw new UserNotFoundException("Karbar peyda nashod!", nameKarbari);
        }
        dataStore.login(nameKarbari, ramzObur);
    }
    ...
    public void loadData() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_NAME))) {
            ...
            System.out.println("❌ Ghalat dar khandan data: " + e.getMessage());
        } catch (NumberFormatException e) {
            System.out.println("❌ Ghalat dar parse kardan adad: " + e.getMessage());
        }
    }
