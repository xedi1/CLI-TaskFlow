...
public class TestFaz1 {
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task("Saḱhtan web site", 3, "2025-02-15");
        Task task2 = new Task("Yaddash avordan dars", 5, "2025-01-20");
        Task task3 = new Task("Tamiz karḋan otagh", 1, "2025-01-25");
        ...
        // ===== FINISH =====
        System.out.println("\n╔════════════════════════════════════════════════════════════╗");
        System.out.println("║     ✅ TEST FAZ 1 BE OMID MOVAFAGH PAYAN YAFT!             ║");
        System.out.println("╚════════════════════════════════════════════════════════════╝");
    }
}